...
class ProdutoTest {
    ...
    void deveCriarProdutoAtivoComDadosValidos() {
        Produto produto = novoProduto("3.000", "18.90");

        assertEquals("7890000000001", produto.getCodigoBarras());
        assertEquals("Caderno universitário 10 matérias", produto.getDescricao());
    ...
    void deveCalcularValorDoEstoque() {
        ...
        assertEquals(0, new BigDecimal("56.70").compareTo(valorEstoque));
    }
